...
public class Shark extends Agent {
    ...
    public Shark(int x, int y) {
        ...
        energy = RANDOM_GENERATOR.nextInt(OceanConfig.SHARK_MAX_ENERGY);
        isAlive = true;
    }
    ...
    private List<Shark> breed(Ocean ocean) {
        ...
        if (freeLocations.size() > 0) {
            if (RANDOM_GENERATOR.nextDouble()
                ...
                deenergise(OceanConfig.SHARK_BREED_ENERGY);
            }
        }
    ...
    private void deenergise(int amount) {
        energy -= amount;
    ...
    private void swim(Ocean ocean) {
        ...
        if (freeLocations.size() > 0) {
            ...
            deenergise(OceanConfig.SHARK_MOVE_ENERGY);
        }
    }
}
